package com.example.da2orderfood.Model;
...
import com.example.da2orderfood.Controller.Interfaces.OdauInterface;
...
//                DataSnapshot snapshotNodeHinhAnhBL = dataSnapshot.child("hinhanhbinluans").child(binhLuanModel.getManbinhluan());
